...
import { Box, Card, Button, CardContent, Chip, CircularProgress, Typography, Table, TableHead, TableRow, TableCell, TableBody } from "@mui/material";
    ...
    return (
        <Box sx={{ p: 4 }}>
            <Box sx={{ display: 'flex', justifyContent: "space-between", mb: 2 }}>
                ...
                <Button variant="contained" onClick={() => router.push("/employees")}>Employees Details</Button>
            </Box>
            <Card sx={{ mb: 4 }}>
                <CardContent>
